    ...
    function _initCandidates(res, obj) {
        candidates = new Candidates(function(res, obj) {
            ...
            res.map((position, xxx) => {
                ...
                boxFootPrev.style = 'width:100px; height: 50px; font-size:20px;'
                console.log('Obj', obj);
                ...
                boxFootSubmit.className = 'btn btn-success btn-md pull-right';
                boxFootSubmit.innerText = 'Submit'
                boxFootNext.style = 'margin-right: 5px; width: 100px; height: 50px; font-size:20px;'
                boxFootSubmit.style = 'margin-left: 5px; width: 100px; height: 50px; font-size:20px;'
                //  boxTitleB.innerText = `${position.description} Election`;
                ...
                boxFootNext.onclick = function() {
                    let radBtn = Array.from(document.getElementsByName('radio_name_' + candidates.current_position.id));
                    ...
                    if (hasSelected) {
                        Swal.fire({
                            ...
                            confirmButtonColor: '#d33', // Set Cancel button color
                            cancelButtonColor: '#3085d6', // Set Confirm (Yes) button color
                            confirmButtonText: 'Cancel', // Change the Confirm button label to "Cancel"
                            cancelButtonText: 'Yes', // Change the Cancel button label to "Yes"
                            customClass: {
                ...
                bodyPSpanClass.value = 'pull-right refresh-btn';
